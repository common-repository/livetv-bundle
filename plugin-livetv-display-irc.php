...
function livetv_do_irc( $atts, $content = null )
{
	...
	{
		echo '<div class="livetv-irc-wrap" style="height:'.$height.'px !important;width:'.$width.'px !important;"><div class="livetv-irc-content" style="width:'.$width.'px;height:'.$height.'px !important;">'.$livetv_good_irc.'</div></div>';
	}
	else
	{
